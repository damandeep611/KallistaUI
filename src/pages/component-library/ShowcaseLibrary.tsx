...
const ShowcaseLibrary: React.FC = () => {
  ...
  return (
    <div className=" p-4 md:p-8">
      <div className="">
        <h1 className="mb-4 text-3xl md:text-4xl font-semibold text-gray-800 dark:text-white">
          All Components
        </h1>
        <p className="max-w-2xl text-base text-neutral-700 dark:text-white mb-2 ">
        ...
        <p className=" flex max-w-2xl text-base text-neutral-700 dark:text-white mb-2">
